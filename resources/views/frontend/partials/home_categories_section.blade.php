                ...
                <div class="d-flex mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-700 mb-0">
                        <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">
                            <img src="{{ static_asset('assets/img/title_bg.png') }}" alt="" />
                            <span class="catname">{{ $category->meta_title }}</span>
                        </span>
                    </h3>
                    <a href="{{ route('products.category', $category->slug) }}" class="ml-auto mr-0 btn btn-primary btn-sm shadow-md">See more</a>
