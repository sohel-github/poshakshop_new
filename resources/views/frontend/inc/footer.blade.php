...
<section class="bg-dark py-5 text-light footer-widget foo">
    <div class="container">
        <div class="row">
                    ...
                    <div class="d-inline-block d-md-block mb-4">
                        <form class="form-inline" method="POST" action="{{ route('subscribers.store') }}">
                            ...
                            <div class="form-group mb-0">
                                <input type="email" class="form-control sub" placeholder="{{ translate('Your Email Address') }}" name="email" required>
                            </div>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            <a href="#" class="opacity-50 hov-opacity-100 text-reset">
                                <b>Licence No : </b> TRAD/DNCC/114674/2022
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="#" class="opacity-50 hov-opacity-100 text-reset">
                                <b>Tin No : </b> 839082270152
                            </a>
                        </li>
                    </ul>
                </div>
...
<!-- FOOTER -->
<footer class="pt-3 pb-7 pb-xl-3 bg-black text-light coo">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                <ul class="list-inline my-3 my-md-0 social colored text-center">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ get_setting('linkedin_link') }}" target="_blank" class="linkedin"><i class="lab la-pinterest"></i></a>
                    </li>
                    @endif
                </ul>
            </div>
