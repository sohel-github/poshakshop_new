                ...
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                        <a href="#" target="_blank"
                            class="text-reset d-inline-block opacity-60">Play Store</a>
                    </li>
                    <!--<li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">-->
                    <!--    <a href="{{ url('shops/create') }}" class="text-reset  d-inline-block opacity-60">Sell with us</a>-->
                    <!--</li>-->
                    <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                        <a href="{{ url('track-your-order') }}" class="text-reset  d-inline-block opacity-60">Track
                            My Order</a>
                    </li>
                    @auth
                        @if (isAdmin())
                    ...
                    @else
                        <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                            <a href="{{ route('user.login') }}"
                                class="text-reset d-inline-block opacity-60">{{ translate('LOGIN') }}</a>
                        </li>
                        <li class="list-inline-item">
                            <a href="{{ route('user.registration') }}"
                                class="text-reset d-inline-block opacity-60">{{ translate('REGISTRATION') }}</a>
                        </li>
                    @endauth
                </ul>
            </div>
