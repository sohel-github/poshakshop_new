                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="text-left">
                            ...
                            @if ($detailedProduct->barcode != null)
                                <hr>
                                <p class="fs-16 text-primary fw-600">Product Code : {{ $detailedProduct->barcode }}</p>
                            @endif
                            ...
                            <form id="option-choice-form">
                                                    ...
                                                    @foreach ($choice->values as $key => $value)
                                                        <label class="aiz-megabox pl-0 mr-2">
                                                            ...
                                                            <span
                                                                ...
                                                                {{ \App\AttributeValue::where('id',$value)->first()->attribute_value_name ?? '' }}
                                                            </span>
                                                        </label>
                                                    @endforeach
                                                </div>
                                ...
                                @if($detailedProduct->emistatus == 1)
                                
                                <label for="name">
                                    {{translate('Walletmix EMI')}}
                                </label>
                                <select class="form-control aiz-selectpicker" name="emi_month" id="">
                                    <option value="">Select month</option>
                                    <?php if($detailedProduct->three) { ?>
                                        <option value="<?php echo $detailedProduct->three == 3 ? 3 : null ?>"><?php echo $detailedProduct->three.' Month'; ?></option>
                                    <?php } ?>
                                    <?php if($detailedProduct->six) { ?>
                                        <option value="<?php echo $detailedProduct->six == 6 ? 6 : null ?>"><?php echo $detailedProduct->six.' Month'; ?></option>
                                    <?php } ?>
                                    <?php if($detailedProduct->nine) { ?>
                                        <option value="<?php echo $detailedProduct->nine == 9 ? 9 : null ?>"><?php echo $detailedProduct->nine.' Month'; ?></option>
                                    <?php } ?>
                                    <?php if($detailedProduct->twelve) { ?>
                                        <option value="<?php echo $detailedProduct->twelve == 12 ? 12 : null ?>"><?php echo $detailedProduct->twelve.' Month'; ?></option>
                                    <?php } ?>
                                </select>
                               ...
                               @endif
                                ...
                                @if ($detailedProduct->pdf != null)
                                    <a href="{{ uploaded_asset($detailedProduct->pdf) }}" class="fs-16 text-primary fw-600 text-reset sizeGuide" data-toggle="modal" data-target="#sizeGuide">{{ translate('Size Guide') }}</a>
                                @endif
                            ...
                            <div class="mt-3">
                                <a href="tel:01554208456" class="btn-link fw-600" style="font-size:0.95rem;"><i class="las la-phone"></i> Call for Order 01554208456</a>
                            </div>
                    ...
                    {{-- <div class="col-xl-3 col-lg-4 ">
                        ...
                        <div class="p-3">
                            <ul class="list-group list-group-flush">
                                @foreach (filter_products(\App\Product::where('user_id', $detailedProduct->user_id)->orderBy('num_of_sale', 'desc'))->limit(4)->get()
                                 as $key => $top_product)
                        ...
                        <div class="card border-0">
                            ...
                            {{-- <div class="d-flex">
                                <span class="font-weight-bold">
                                    <i class="las la-search-location la-2x"></i>
                                </span>
                                <p class="font-weight-bold ml-2" id="country-location">
                                    Dhaka, Dhaka North Banani Road no, 12 - 19
                                </p>
                                <a href="#" class="nav-link" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Change</a>
                                <div class="dropdown-menu" id="dropDown" aria-labelledby="dropdownMenuButton" style="height:250px !important;overflow-y: auto;">
                        ...
                        @if ($detailedProduct->added_by == 'seller' && get_setting('vendor_system_activation') == 1)
                            <div class="row no-gutters align-items-center border-top">
                                ...
                                <div class="col">
                                    @if (get_setting('conversation_system') == 1)
                                    <div class="col-auto">
                                        <button class="d-block btn-sm btn-soft-primary rounded-0 border-0 py-2"
                                            onclick="show_chat_modal()">{{ translate('Message Seller') }}</button>
                                    </div>
                                @endif
    ...
    <script type="text/javascript">
        ...
        var url = "{{ route('get-shipping-details') }}";
            ...
            success: function (data) {
                $('#shipping-price').html();
                $('#country-location').html();
                $('#shipping-price').text("৳ "+data.city.cost);
                $('#country-location').text(data.country.name +", "+ data.city.name);
            //     if (data.product.cash_on_delivery == 1) {
            //         $('#cash-on-delivery').text("Cash on delivery available");
            //     }else{
            //         $('#cash-on-delivery').text("Cash on delivery not available");
            //     }

            //   if (data.product.refundable == 1)
            //   {
            //     $('#return-days').text("7 Days Return");
            //   }
            //   else
            //   {
            //     $('#return-days').text('Refund not available')
            //   }
        ...
        $('.sizeGuide').click(function(){
            ...
            $('#sizeContent').html('<img src="'+url+'" class="img-fit" />');
        });
