...
@section('content')
    ...
    <div id="new_home_slider" class="container">
        <div class="row">
                ...
                @if (get_setting('home_slider_images') != null)
                    <div class="aiz-carousel dots-inside-bottom mobile-img-auto-height" data-arrows="true" data-dots="false" data-autoplay="true">
                        ...
                        @foreach ($slider_images as $key => $value)
                            <div class="carousel-box" id="furn_slider">
                                <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                                    ...
                                    >
                                    <div id="furn_slider_content">
                                        <h1 class="h1 fw-300 mb-2">{{ json_decode(get_setting('home_slider_title'), true)[$key] }}</h1>
                                        <h3 class="h4 fw-200 mb-0" style="color:#f0ff24;">{{ json_decode(get_setting('home_slider_title'), true)[$key] }}</h3>
                                    </div>
                                </a>
                            </div>
                        @endforeach
        ...
        <div class="grid-wrapper">
            @if (count($featured_categories) > 0)
                @foreach ($featured_categories as $key => $category)
                    <div onclick="window.location.href='{{ route('products.category', $category->slug) }}'">
                        <img
