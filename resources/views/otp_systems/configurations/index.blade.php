...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('eSMS')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        <input type="hidden" name="otp_method" value="esms">
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="ESMS_API_KEY">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('ESMS_API_KEY')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="ESMS_API_KEY" value="{{  env('ESMS_API_KEY') }}" placeholder="ESMS_API_KEY" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="ESMS_USERNAME">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('ESMS_USERNAME')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="ESMS_USERNAME" value="{{  env('ESMS_USERNAME') }}" placeholder="ESMS_USERNAME" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="ESMS_TYPE">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('ESMS_TYPE')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="ESMS_TYPE" value="{{  env('ESMS_TYPE') }}" placeholder="ESMS_TYPE" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="ESMS_SENDER_ID">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('ESMS_SENDER_ID')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="ESMS_SENDER_ID" value="{{  env('ESMS_SENDER_ID') }}" placeholder="ESMS_SENDER_ID" required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
