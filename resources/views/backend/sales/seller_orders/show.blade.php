    		...
    		<div class="">
                    ...
                    @foreach ($order->orderDetails->where('seller_id', '!=', $admin_user_id) as $key => $orderDetail)
                        <tr>
                            ...
                            <td>
                                @if ($orderDetail->product != null)
                               {{  $orderDetail->product->stocks->where('variant',$orderDetail->variation)->first()->sku ?? translate('N/A')  }}
                                @else
                                <strong>{{ translate('N/A') }}</strong>
                                @endif
                            </td>
                            <td class="text-center">
                                @if ($orderDetail->attribute_id != null)
                                 {{ \App\AttributeValue::where('id',$orderDetail->attribute_id)->first()->attribute_value_name ?? translate('N/A') }}
                                 @else
                                <strong>{{ translate('N/A') }}</strong>
                                 @endif
                            </td>
