                        ...
                        <td>
                            @php
                                ...
                                if($product->variant_product) {
                                    ...
                                    ?>
                                        <input onchange="update_qty(this)" type="number" min="0" max="1000" value="<?php echo $qty; ?>" id="<?php echo $product->id; ?>" size="1" style="border: 2px solid #b1b1b7;text-align: center;padding: 3px 6px;border-radius: 5px;" />
                                    <?php
                                    // echo $qty;
                                }
                            @endphp
...
@section('script')
    <script type="text/javascript">
        ...
        function update_qty(el){
            ...
            $.post('{{ route('classified_product.qtyupdate') }}', {_token:'{{ csrf_token() }}', id:el.id, qty:el.value}, function(data){
                //console.log(data);
                if(data){
                    AIZ.plugins.notify('success', '{{ translate('Product quantity updated successfully') }}');
                }
                else{
                    AIZ.plugins.notify('danger', '{{ translate('Something went wrong') }}');
                }
