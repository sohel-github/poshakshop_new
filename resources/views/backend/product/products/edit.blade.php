            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Product Code')}}</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="barcode" placeholder="{{ translate('Product Code') }}" value="{{ $product->barcode }}">
                            </div>
                        </div>
                        @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control aiz-selectpicker attribute_choice" data-live-search="true" name="choice_options_{{ $choice_option->attribute_id }}[]" multiple>
                                        @foreach (\App\AttributeValue::where('attribute_id', $choice_option->attribute_id)->get() as $row)
                                        <option value="{{ $row->id }}" @if( in_array($row->id, $choice_option->values)) selected @endif>
...
<!--                <div class="card">
            ...
            <div class="col-lg-4">
                ...
                <!--            <div class="col-md-6">-->
                <!--                <label class="aiz-switch aiz-switch-success mb-0">-->
                <!--                    <input type="radio" name="emistatus" value="1" @if($product->emistatus == '1') checked @endif>-->
                <!--                    <span></span>-->
                <!--                </label>-->
                <!--            </div>-->
                ...
                <!--            <div class="col-md-6">-->
                <!--                <label class="aiz-switch aiz-switch-success mb-0">-->
                <!--                    <input type="radio" name="emistatus" value="0" @if($product->emistatus == '0') checked @endif>-->
                <!--                    <span></span>-->
                <!--                </label>-->
                <!--            </div>-->
                <!--        </div>-->
                ...
                <!--                <div class="">-->
                <!--                    <label class="aiz-switch aiz-switch-success mb-0">-->
                <!--                        <input type="checkbox" name="three" value="3" @if($product->three == '3') checked @endif>-->
                <!--                        <span></span>-->
                <!--                    </label>-->
                <!--                </div>-->
                <!--            </div>-->
                ...
                <!--                <div class="">-->
                <!--                    <label class="aiz-switch aiz-switch-success mb-0">-->
                <!--                        <input type="checkbox" name="six" value="6" @if($product->six == '6') checked @endif>-->
                <!--                        <span></span>-->
                <!--                    </label>-->
                <!--                </div>-->
                <!--            </div>-->
                ...
                <!--                <div class="">-->
                <!--                    <label class="aiz-switch aiz-switch-success mb-0">-->
                <!--                        <input type="checkbox" name="nine" value="9" @if($product->nine == '9') checked @endif>-->
                <!--                        <span></span>-->
                <!--                    </label>-->
                <!--                </div>-->
                <!--            </div>-->
                ...
                <!--                <div class="">-->
                <!--                    <label class="aiz-switch aiz-switch-success mb-0">-->
                <!--                        <input type="checkbox" name="twelve" value="12" @if($product->twelve == '12') checked @endif>-->
                <!--                        <span></span>-->
                <!--                    </label>-->
                <!--                </div>-->
                <!--            </div>-->
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <select class="form-control aiz-selectpicker" name="warranty">
                                    <option value="" disabled>Select Product Warranty</option>
