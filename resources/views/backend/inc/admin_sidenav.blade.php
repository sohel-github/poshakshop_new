                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                ...
                                <ul class="aiz-side-nav-list level-3">
                                    ...
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('divisions.index')}}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{translate('Shipping Division')}}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('districts.index')}}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{translate('Shipping District')}}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('areas.index')}}" class="aiz-side-nav-link">
