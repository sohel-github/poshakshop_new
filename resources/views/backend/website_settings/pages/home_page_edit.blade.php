				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="home-slider-target">
							...
							<input type="hidden" name="types[]" value="home_slider_desc">
								...
								@foreach (json_decode(get_setting('home_slider_images'), true) as $key => $value)
									<div class="row gutters-5">
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_slider_desc">
												<input type="text" class="form-control" placeholder="Details" name="home_slider_desc[]" value="{{ json_decode(get_setting('home_slider_desc'), true)[$key] }}">
											</div>
										</div>
						...
						<button
							...
							<div class="row gutters-5">
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_slider_desc">
										<input type="text" class="form-control" placeholder="Details" name="home_slider_desc[]">
									</div>
								</div>
