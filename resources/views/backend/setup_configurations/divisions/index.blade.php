...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
    	<div class="row align-items-center">
    		<div class="col-md-12">
    			<h1 class="h3">{{translate('All Division')}}</h1>
    		</div>
    	</div>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header row gutters-5">
                    <div class="col text-center text-md-left">
                        <h5 class="mb-md-0 h6">{{ translate('Division') }}</h5>
                    </div>
                    <div class="col-md-4">
                        ...
                        <tbody>
                            @foreach($divisions as $key => $division)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('divisions.edit', ['id'=>$division->id, 'lang'=>env('DEFAULT_LANGUAGE')]) }}" title="{{ translate('Edit') }}">
                                            <i class="las la-edit"></i>
                                        </a>
                                        <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('divisions.destroy', $division->id)}}" title="{{ translate('Delete') }}">
