    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header ">
                    <h5 class="mb-0 h6">{{translate('Walletmix Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        @csrf
                        <input type="hidden" name="payment_method" value="walletmix">
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="WALLETMIX_APP_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('WALLETMIX APP KEY')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="WALLETMIX_APP_KEY" value="{{  env('WALLETMIX_APP_KEY') }}" placeholder="{{translate('WALLETMIX APP KEY')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="WALLETMIX_APP_PASSWORD">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('WALLETMIX APP PASSWORD')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="WALLETMIX_APP_PASSWORD" value="{{  env('WALLETMIX_APP_PASSWORD') }}" placeholder="{{translate('WALLETMIX APP PASSWORD')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="WALLETMIX_USER_NAME">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('WALLETMIX USER NAME')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="WALLETMIX_USER_NAME" value="{{  env('WALLETMIX_USER_NAME') }}" placeholder="{{translate('WALLETMIX USER NAME')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="WALLETMIX_MERCHANT_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('WALLETMIX MERCHANT ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="WALLETMIX_MERCHANT_ID" value="{{  env('WALLETMIX_MERCHANT_ID') }}" placeholder="{{translate('WALLETMIX MERCHANT ID')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="WALLETMIX_MERCHANT_DOMAIN">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('WALLETMIX MERCHANT DOMAIN')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="WALLETMIX_MERCHANT_DOMAIN" value="{{  env('WALLETMIX_MERCHANT_DOMAIN') }}" placeholder="{{translate('WALLETMIX MERCHANT DOMAIN')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Walletmix Enable')}}</label>
                            </div>
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="walletmix" type="checkbox" @if (get_setting('walletmix') == 1)
                                        checked
                                    @endif>
                                    <span class="slider round"></span>
                                </label>
