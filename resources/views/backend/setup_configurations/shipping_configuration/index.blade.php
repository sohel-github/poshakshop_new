        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('shipping_configuration.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="radio mar-btm">
                        <input id="thana-shipping" class="magic-radio" type="radio" name="shipping_type" value="thana_wise_shipping" <?php if(get_setting('shipping_type') == 'thana_wise_shipping') echo "checked";?>>
                        <label for="thana-shipping">{{translate('Thana Wise Flat Shipping Cost')}}</label>
                    </div>
