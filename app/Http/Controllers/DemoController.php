...
class DemoController extends Controller
{
    ...
    public function convert_assets(Request $request)
    {
        ...
        $business_setting->save();
        $business_setting = BusinessSetting::where('type', 'home_slider_title')->first();
        $business_setting->value = json_encode(Slider::pluck('title')->toArray());
        $business_setting->save();
        $business_setting = BusinessSetting::where('type', 'home_slider_desc')->first();
        $business_setting->value = json_encode(Slider::pluck('desc')->toArray());
        $business_setting->save();
