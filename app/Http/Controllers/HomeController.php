...
class HomeController extends Controller
{
    ...
    public function product(Request $request, $slug)
    {
        ...
        //dd($detailedProduct);
        $cities = City::where('country_id',18)->get();
        if($detailedProduct != null && $detailedProduct->published){
            ...
            if($detailedProduct->digital == 1){
                ...
                return view('frontend.product_details', compact('detailedProduct','cities'));
            }
...
//        }
    ...
    public function getShippingDetails(Request $request)
    {
        ...
        $city = City::where('id',$id)->first(['cost','name','country_id']);
        $country = Country::where('id',$city->country_id)->first();
        $product = Product::where('id',$product_id)->first(['cash_on_delivery','est_shipping_days','refundable','product_scope']);
        return response()->json(['city' => $city,'product' => $product,'country' => $country]);
    }
}
