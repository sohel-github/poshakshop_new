...
//            $val = $row->id . ' | ' . $row->name;
            $html .= '<option value="' . $row->id . '">' . $row->attribute_value_name . '</option>';
        }
    ...
    public function store(Request $request)
    {
        ...
        //$variations = array();
        $product->product_scope = $request->product_scope;
        $product->save();
        ...
        if ($request->has('emistatus')) {
            $product->emistatus = $request->emistatus;
        }
