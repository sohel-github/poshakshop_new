...
Route::post('/wmxpayment', 'WalletmixController@wmxpayment');
...
Route::get('/division', 'DivisionController@getDivision')->name('divisions.get');
Route::get('/district', 'DistrictController@getDistrictById')->name('districts.get');
Route::get('/area', 'AreaController@getAreaById')->name('areas.get');
...
Route::get('/get-shipping-details', 'HomeController@getShippingDetails')->name('get-shipping-details');
