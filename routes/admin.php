...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::post('/classified_products/qtyupdate', 'CustomerProductController@qtyUpdate')->name('classified_product.qtyupdate');
    ...
    Route::get('/division', 'DivisionController@index')->name('divisions.index');
    Route::post('/division/store', 'DivisionController@store')->name('divisions.store');
    Route::get('/division/edit/{id}', 'DivisionController@edit')->name('divisions.edit');
    Route::patch('/division/update/{id}', 'DivisionController@update')->name('divisions.update');
    Route::get('/division/delete/{id}', 'DivisionController@destroy')->name('divisions.destroy');


    Route::get('/district', 'DistrictController@index')->name('districts.index');
    Route::post('/district/store', 'DistrictController@store')->name('districts.store');
    Route::get('/district/edit/{id}', 'DistrictController@edit')->name('districts.edit');
    Route::patch('/district/update/{id}', 'DistrictController@update')->name('districts.update');
    Route::get('/district/delete/{id}', 'DistrictController@destroy')->name('districts.destroy');


    Route::get('/area', 'AreaController@index')->name('areas.index');
    Route::post('/area/store', 'AreaController@store')->name('areas.store');
    Route::get('/area/edit/{id}', 'AreaController@edit')->name('areas.edit');
    Route::patch('/area/update/{id}', 'AreaController@update')->name('areas.update');
    Route::get('/area/delete/{id}', 'AreaController@destroy')->name('areas.destroy');
